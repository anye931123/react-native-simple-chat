...
export default class PictureToolBar extends Component {
    ...
    render() {
        const {gotoAlbum,selectImages,sendImageMessagesFn,editImageFn,toolBarShow} = this.props
                ...
                <View style={styles.radioContainer}>
                    ...
                    <View style={styles.container1}>
                        ...
                        >
                            ...
                            <SelectCircleButton circleStyle={toolBarShow&&{borderColor:Colors.white}} btnStyle={styles.centerBtn} onPress={()=>{
                                this.setState({
